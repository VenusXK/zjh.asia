export default function Foot(){
    return (
        <>
        <div className="w-full h-32 sm:h-26 bg-none items-center justify-center text-center">
                <div className="line-clamp-1 sm:px-10 text-center translate-y-14" style={{ color: '#fff', fontSize: 'small' }}>
